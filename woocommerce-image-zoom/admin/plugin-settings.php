...
if (!class_exists('WPB_WIZ_Plugin_Settings')):
    class WPB_WIZ_Plugin_Settings
    {
        ...
        function admin_menu()
        {
            add_submenu_page(
                'woocommerce',
                esc_html__('WC Product Images Zoom Settings', 'woocommerce-image-zoom'),
                esc_html__('Image Zoom', 'woocommerce-image-zoom'),
                'manage_options',
                'wpb_woocommerce_image_zoom_settings',
...
?>
            <div class="wpb-wiz-pro">
                <h3>Enjoying the Product Image Zoom plugin? Upgrade to the premium version and get a 10% exclusive discount. Use promo code- <b style="color: #dc3232;">NewCustomer</b></h3>
            ...
            <style type="text/css">
                ...
                .wpb-wiz-pro .button:hover,
                .wpb-wiz-pro .button:focus {
                    color: #fff;
                }
                ...
                .wp-core-ui .button.wpb-wiz-button-primary:hover,
                .wp-core-ui .button.wpb-wiz-button-primary:focus {
                    background: #c0392b;
                }

                .wp-core-ui .button.wpb-wiz-button-secondary:hover,
                .wp-core-ui .button.wpb-wiz-button-secondary:focus {
                    background: #7f8c8d;
                }
            </style>
<?php
