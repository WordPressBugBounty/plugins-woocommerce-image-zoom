 ...
 * WordPress.org Compatible Version with Proper Escaping and Sanitization
 *
...
if (!class_exists('WPB_WIZ_WeDevs_Settings_API')):
    class WPB_WIZ_WeDevs_Settings_API
    {
        ...
        function callback_file($args)
        {
            ...
            $label = isset($args['options']['button_label']) ? $args['options']['button_label'] : __('Choose File', 'woocommerce-image-zoom');
                ...
                <?php foreach ($this->settings_sections as $form) { ?>
                    <div id="<?php echo esc_attr($form['id']); ?>" class="group" style="display: none;">
                        <form method="post" action="options.php">
                            <?php
                            do_action('wiz_form_top_' . $form['id'], $form);
                            settings_fields($form['id']);
                            do_settings_sections($form['id']);
                            do_action('wiz_form_bottom_' . $form['id'], $form);
